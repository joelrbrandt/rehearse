...
public class RehearseEditorToolbar extends EditorToolbar {
	  ...
	  public RehearseEditorToolbar(Editor editor, JMenu menu) {
	    this.editor = editor;
	    this.menu = menu;
	  ...
	  public void mousePressed(MouseEvent e) {
	    ...
	    case OPEN:
	      ...
	      popup.show(RehearseEditorToolbar.this, x, y);
	      break;
...
//	    setState(RUN, yesno ? ACTIVE : INACTIVE, true);
	//  }
	  ...
	  private int whichIndex(int what) {
	  ...
	  public void activate(int what) {
	    ...
	    if (inactive == null) return;
	    setState(whichIndex(what), ACTIVE, true);
	  }
	  ...
	  public void deactivate(int what) {
	    ...
	    setState(whichIndex(what), INACTIVE, true);
	  }
